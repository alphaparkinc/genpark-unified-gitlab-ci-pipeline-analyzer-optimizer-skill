# genpark-unified-gitlab-ci-pipeline-analyzer-optimizer-skill
...
> **GenPark AI Agent Skill** -- Unified GitLab CI pipeline analyzer & stage optimizer (GitLab CI Lint style)
